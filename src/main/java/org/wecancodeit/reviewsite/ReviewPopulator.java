...
public class ReviewPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		reviewRepo.save(new Review(videogames, "Guitar Hero 17",
				"I feel like I can play an actual guitar after playing this game ", "/images/GuitarHero.jpg"));
		reviewRepo.save(new Review(books, "Rocketboys", "The best thing to come out of West Virginia",
				"/images/RocketBoys.jpg"));
		reviewRepo.save(new Review(books, "Harry Potter and the sorcerers stone",
